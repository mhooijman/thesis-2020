...
def main():
    ...
    # # Encoding experiment of sentence length on full model activations of common voice
    # activations_dir = './results/activations'
    # results_full_model_common = do_sentence_length_encoding_experiment_common_voice(sets=sets_to_use, 
    #                 activations_dir=activations_dir)

    # # Encoding experiment of sentence length on 0.1 pruned model activations of common voice
    # activations_dir = './results/activations/pruned-10.0'
    ...
    # # Encoding experiment of sentence length on full model activations of librispeech
    # activations_dir = './results/activations/libri'
    ...
    # # Encoding experiment of sentence length on 0.1 pruned model activations of librispeech
    # activations_dir = './results/activations/libri/pruned-10.0'
